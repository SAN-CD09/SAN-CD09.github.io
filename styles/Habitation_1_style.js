var size = 0;
var placement = 'point';
function categories_Habitation_1(feature, value, size, resolution, labelText,
                       labelFont, labelFill) {
...
var style_Habitation_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_Habitation_1(feature, value, size, resolution, labelText,
                          labelFont, labelFill);
